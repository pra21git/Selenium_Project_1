...
exports.config = {
 ...
 // specs: ['../SpecFiles/*_spec.js'],
  //specs: ['../SpecFiles/17-GuestDetailsTest_spec.js'],
  specs: ['../SpecFiles/GuestServices/21-NewAccountTest_spec.js'],
 // specs: ['../SpecFiles/GuestServices/*_spec.js'],
...
//reporting
    ...
    onComplete: function () {
      ...
      process.chdir('../Target/'+report_name);
